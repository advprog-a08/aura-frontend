...
export default function PesananPage() {
  ...
  const [ongoingOrders] = useState(initialOngoingOrders)
    ...
    <CustomerLayout>
      <div className="container mx-auto p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-300">Manage your current cart and view ongoing orders</p>
        </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                          ...
                          <div className="flex-1 p-4">
                            ...
                            <div className="flex justify-between items-center mt-4">
                              <div className="flex items-center gap-3">
                                <Button variant="outline" size="icon" onClick={() => decreaseQuantity(cartItem.id)}>
                                  <Minus className="h-4 w-4" />
                                </Button>
                                <span className="font-medium">{cartItem.quantity}</span>
                                <Button variant="outline" size="icon" onClick={() => increaseQuantity(cartItem.id)}>
              ...
              <div>
                <Card>
                  ...
                  <CardFooter>
                    <Button asChild className="w-full bg-green-700 hover:bg-green-800" disabled={cart.length === 0}>
          ...
          <TabsContent value="ongoing">
            <div className="space-y-6">
              {ongoingOrders.length > 0 ? (
                  ...
                  <Card key={order.id} className="overflow-hidden">
                    ...
                    <CardContent>
                      <div className="flex items-center gap-2 text-sm text-gray-500 mb-4">
                        ...
                        <span>Ordered at {formatDate(order.timestamp)}</span>
                ...
                <Card className="p-8 text-center">
                  <p className="text-gray-500 dark:text-gray-400 mb-4">You don't have any ongoing orders</p>
                  <Button asChild className="bg-green-700 hover:bg-green-800">
